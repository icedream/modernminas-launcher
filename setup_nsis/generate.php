...
if(!file_exists("$path/setup.exe"))
  system(escapeshellarg("C:\\Program Files (x86)\\NSIS\\MakeNSIS.exe") . " /DCONFIGURATION=Release /DSOURCE_BIN_PATH=../launcher/bin/Release /DVERSION=$version ".escapeshellarg(dirname(__FILE__) . "\\Setup.nsi"));
if(!file_exists("$path/setup.exe"))
