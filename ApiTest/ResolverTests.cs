...
namespace ApiTest
{
    ...
    public class ResolverTests
    {
        ...
        [TestMethod]
        public void GetPackageFromXml()
        {
            XmlDocument xmldoc = new XmlDocument();
            xmldoc.LoadXml("<package><name>test</name><version>test</version><options><selector id=\"awesomeselector\"><choice value=\"1\" default=\"false\">A</choice><choice value=\"2\" default=\"true\">B</choice><choice value=\"3\" description=\"test\">C</choice></selector></options><source><resolver type=\"download\"><url>http://test.modernminas.de/</url></resolver><resolver type=\"archive\" /></source></package>");
            Package testPackage = new Package(xmldoc.FirstChild);
            if (!testPackage.Name.Equals("test") || !testPackage.Version.Equals("test"))
                throw new Exception("Package metadata mismatch");
            if (!testPackage.Selectors.Any())
                throw new Exception("Selector count mismatch");
        }
        ...
        [TestMethod]
        public void OptifinePackageResolve()
        {
            var xmldoc = new XmlDocument();
            xmldoc.Load("http://repo.update.modernminas.de/repository/v3/optifine.xml");
            Package p = new Package(xmldoc.FirstChild);
        }
